...
import phoenix from './phoenix_blue.png';
...
import aadhaar_dp from './aadhaar_dp.jpg'
import aadhaar1 from './aadhaar-1.jpg'
import aadhaar2 from './aadhaar-2.jpg'
import aadhaar3 from './aadhaar-3.jpg'
...
class Aadhaar extends React.Component {
       ...
       constructor() {
          super();
            this.state = {tweets:0,followers:0,following:0,searchBorder:'1px solid grey',searchHeight:'30px'}
       };
       ...
       render(){
        ...
        <div className='container'>
          ...
          <div className='aadhar'>aadhaar</div>
          <AppBar style={{background:'#1DA1F2',height:'45px'}} showMenuIconButton={false} titleStyle={{flex:0}}>
            <Tabs zDepth={4} inkBarStyle={{background:'#ffffff',width:110}} contentContainerStyle={{width:'800px'}}>
              <Tab className='tab' disableTouchRipple={true} style={{background: '#1DA1F2', height:'45px'}} labelStyle={{textDecoration:'none',color:'#ffffff'}} label='top' />
              <Tab className='tab' disableTouchRipple={true}  style={{background: '#1DA1F2', height:'45px'}} labelStyle={{textDecoration:'none',color:'#ffffff'}} label="latest" />
              <Tab className='tab' disableTouchRipple={true}  style={{background: '#1DA1F2', height:'45px'}} labelStyle={{textDecoration:'none',color:'#ffffff'}} label="people" />
              <Tab className='tab' disableTouchRipple={true}  style={{background: '#1DA1F2', height:'45px'}} labelStyle={{textDecoration:'none',color:'#ffffff'}} label="photos" />
              <Tab className='tab' disableTouchRipple={true}  style={{background: '#1DA1F2', height:'45px'}} labelStyle={{textDecoration:'none',color:'#ffffff'}} label="videos" />
              <Tab className='tab' disableTouchRipple={true}  style={{background: '#1DA1F2', height:'45px'}} labelStyle={{textDecoration:'none',color:'#ffffff'}} label="news" />
              <Tab className='tab' disableTouchRipple={true}  style={{background: '#1DA1F2', height:'45px'}} labelStyle={{textDecoration:'none',color:'#ffffff'}} label="broadcasts" />
            </Tabs>
            <FlatButton disableTouchRipple={true} hoverColor='#eeeeee'style={{marginLeft:300,marginTop:7,borderRadius:30,height:30,width:150,paddingRight:0,minWidth:80, lineHeight:'0px'}}
             backgroundColor='#eeeeee' hoverColor='#ffffff' label="Follow search" labelStyle={{color:'#1DA1F2',textTransform:'capitalize'}} primary={false} />
            <IconMenu
              anchorOrigin={{ vertical: 'bottom', horizontal: 'left',}}
              iconButtonElement={<IconButton tooltip="More search actions"><MenuIcon/></IconButton>}
              onChange={this.handleChangeSingle}
              value={this.state.valueSingle}
            >
              <MenuItem value="1" primaryText="Search settings" />
              <MenuItem value="2" primaryText="Embed this search" />
            </IconMenu>
          </AppBar>
          <div style={{position:'absolute',display:'inline'}}>
            <Paper  className='links' zDepth={1} rounded={false} style={{background:'#ffffff',height:40,width:285,marginTop:20,padding:12,marginLeft:150,fontFamily: 'Segoe UI',fontWeight:'bold',fontSize:'18px'}}>Search filters . <a href='#' style={{fontSize:12,color:'#1DA1F2',fontWeight:'normal'}}>show</a></Paper>
            <Paper className='links' zDepth={1} rounded={false} style={{background:'#ffffff',height:160,width:285,marginTop:10,padding:12,marginLeft:150,fontFamily: 'Segoe UI',fontWeight:'bold',fontSize:'18px'}}>Related searches<br/>
                <a href='#'>vadgam</a><br/>
                <a href='#'>#sardarpatel</a><br/>
                <a href='#'>teesta setalvad</a><br/>
                <a href='#'>#himachalresults</a><br/>
                <a href='#'>surat</a><br/>
            </Paper>
            <Paper style={{padding:10,height: 360,width: 285,marginLeft:150, marginTop:10,fontFamily:'Helvetica Neue',fontSize:15}} zDepth={1} rounded={false}>
            ...
            <Paper style={{height: 330, width: 285, marginTop: 10, marginLeft:150, padding:10, fontFamily:'Helvetica Neue', fontSize:30}} zDepth={1} rounded={false}>
              <div style={{backgroundColor: '#ffffff', width: 275, height:0, color:'#311B92'}}>
          ...
          <Paper style={{ padding: 10, height: 2260,width: 600, marginTop:20, display: 'inline',position:'absolute',left:450, fontFamily:'Helvetica Neue', fontSize:12}} zDepth={1} rounded={false}>
            <div style={{paddingLeft:30}}>
             <span>
               <Avatar src={aadhaar_dp} className='avatar'/>
               <IconButton style={{height:20,width:20,left:'450px'}}><ExpandIcon/></IconButton>
             </span>
             <span>
             <a className='name'>Aadhaar</a>
             <a className='userName'>@UIDAI . 4m</a>
             ...
             Hasura data APIs! Clone & deploy in 3 simple steps - <a style={{color:'#1DA1F2'}}>https://hasura.io/hub/project/hasura/hello-python-flask
              … #python #flask #appdev #webdev #DevOps #Microservices</a></p>
              </span>
              <br/>
              <img src={aadhaar1} style={{height:500, width:500, border:'1px solid #eeeeee',borderRadius:5,marginLeft:20}}/>
              <br/>
              <div>
            ...
            <div style={{paddingLeft:30}}>
              <span>
                <Avatar src={dig_india_dp} className='avatar'/>
                <IconButton style={{height:20,width:20,left:'450px'}}><ExpandIcon/></IconButton>
              </span>
              <span>
                <a className='name'>Digital India</a>
                <a className='userName'>@digitalIndia . 1h</a>
                <p className='tweetText'>
                <a style={{color:'#1DA1F2'}}>#DigitalIdentity</a> | This chart will answer all your queries regarding linking of <a style={{color:'#1DA1F2'}}>#Aadhaar</a> (<a style={{color:'#1DA1F2'}}>@UIDAI</a>) with PAN card.
                </p></span>
                <br/>
                <img src={aadhaar2} style={{height:300, width:500, border:'1px solid #eeeeee',borderRadius:5,marginLeft:20}} alt="" />
                <br/>
                <div>
                  <IconButton  className='c_icons' tooltip="Reply" ><ReplyIcon/></IconButton><a className='c_numbers c_reply'>344</a>
                  <IconButton  className='c_icons' tooltip="Retweet" ><RetweetIcon/></IconButton><a className='c_numbers c_retweet'>3.8k</a>
             ...
             <div style={{paddingLeft:30}}>
               ...
               <span>
                 ...
                 <a className='userName'>@UIDAI . 4m</a>
                 <p className='tweetText'>
                 <a style={{color:'#1DA1F2'}}>#AadhaarInNews</a> : Good news for people in <a style={{color:'#1DA1F2'}}>#TamilNadu</a>
                  - More post offices to join Aadhaar drive. Read more -</p></span>
                  <br/>
                  <img src={aadhaar3} style={{height:300, width:500, border:'1px solid #eeeeee',borderRadius:5,marginLeft:20}} alt="" />
                  <br/>
                  <div>
                    <IconButton  className='c_icons' tooltip="Reply" ><ReplyIcon/></IconButton><a className='c_numbers c_reply'>344</a>
                    <IconButton  className='c_icons' tooltip="Retweet" ><RetweetIcon/></IconButton><a className='c_numbers c_retweet'>3.8k</a>
              ...
              <div style={{paddingLeft:30}}>
                ...
                <span>
                  ...
                  <a className='userName'>@UIDAI . 4m</a>
                  <p className='tweetText'>
                  The charges for Aadhaar update are max. Rs 30 (Rs 25+GST = Rs 30 approx). If the center charges you more, DO NOT pay. Report. We
                  will create a complaint on your behalf & action shall be taken.We have very strict rules against any corrupt practice in the system.
                  <div style={{color:'blue'}}>#AadhaarEssentials</div></p></span>
                   <br/>
                   <img src={aadhaar4} style={{height:300, width:500, border:'1px solid #eeeeee',borderRadius:5,marginLeft:20}} alt="" />
                   <br/>
                   <div>
                     <IconButton  className='c_icons' tooltip="Reply" ><ReplyIcon/></IconButton><a className='c_numbers c_reply'>344</a>
                     <IconButton  className='c_icons' tooltip="Retweet" ><RetweetIcon/></IconButton><a className='c_numbers c_retweet'>3.8k</a>
                     <IconButton  className='c_icons' tooltip="Like" ><HeartIcon/>k</IconButton><a className='c_heart c_numbers'>1k</a>
                     <IconButton  className='c_icons' tooltip="DM" ><EmailIcon/></IconButton>
                   </div>
               </div>
               <hr style={{color:'#eeeeee'}}/>
